...
// ה-Fetcher מחזיר עכשיו נתונים שטוחים (מערכים) בלבד - זה קריטי ליציבות של SWR!
const fetcher = async () => {
...
export default function MarketplacePage() {
  // SWR מוגדר עם הגדרות אבטחה וביצועים מיוחדות למניעת ריצודים (keepPreviousData)
  ...
  // שימוש ב-useMemo כדי ש-Set יווצר רק כשבאמת יש שינוי בנתונים
  ...
  // סוקט לזמן אמת מאובטח תחת זיהוי הבניין
  useEffect(() => {
  ...
  // מניעת מסך שחור / ריק בזמן טעינה ראשונית. keepPreviousData דואג לשאר!
