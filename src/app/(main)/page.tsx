      ...
      <div className="grid grid-cols-1 gap-4 px-4 relative z-10">
        ...
        >
          ...
          <div className="flex-1 relative z-10 min-w-0">
            ...
            <p className={`text-sm font-bold truncate ${openTickets > 0 ? 'text-orange-100' : 'text-emerald-500'}`}>
        ...
        >
          ...
          <div className="flex-1 relative z-10 min-w-0">
            ...
            <p className={`text-sm font-bold truncate ${requestsCount > 0 ? 'text-purple-100' : 'text-emerald-500'}`}>
        ...
        >
          ...
          <div className="flex-1 relative z-10 min-w-0">
            ...
            <p className={`text-sm font-bold truncate ${latestAnnouncement ? 'text-emerald-100' : 'text-emerald-500'}`}>
