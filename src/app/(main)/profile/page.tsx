...
export default function ProfilePage() {
  ...
  useEffect(() => {
    fetchData()
    const channel = supabase.channel('profile_realtime_v20')
  ...
  if (isLoading) {
    return <div className="flex flex-col flex-1 w-full items-center justify-center pb-32 bg-[#F8FAFC]"><div className="w-10 h-10 border-4 border-slate-200 border-t-[#1D4ED8] rounded-full animate-spin"></div><p className="mt-4 font-bold text-slate-600">טוען נתונים...</p></div>
  }
  ...
  return (
    <div className="flex flex-col flex-1 w-full pb-32 bg-[#F8FAFC]" dir="rtl">
      ...
      {/* אזור פרטים אישיים - נקי לגמרי */}
      <div className="px-4 mb-8">
        <div className="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-[0_2px_15px_rgb(0,0,0,0.03)] flex flex-col gap-5">
          <div className="flex items-center gap-4">
            ...
            <div onClick={() => setIsAvatarMenuOpen(true)} className="relative w-24 h-24 shrink-0 cursor-pointer group block">
              ...
              <div className="absolute bottom-0 right-0 bg-white p-2 rounded-full shadow-md border border-slate-100 text-[#1D4ED8] group-active:scale-90 transition z-20">
            ...
            <div className="flex-1">
              <input
                ...
                className="text-xl font-black text-slate-800 leading-tight bg-transparent outline-none w-full border-b border-dashed border-slate-200 focus:border-[#1D4ED8] pb-1 transition-colors"
                placeholder="שם מלא"
              />
              <span className={`text-[10px] font-bold px-2.5 py-1 rounded-lg mt-2 inline-block ${!building ? 'bg-orange-50 text-orange-600' : isPending ? 'bg-yellow-50 text-yellow-600' : isAdmin ? 'bg-[#E3F2FD] text-[#1D4ED8]' : 'bg-slate-100 text-slate-700'}`}>
          ...
          <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 flex flex-col gap-4">
            <div className="flex flex-col gap-3">
              <div className="w-full">
                <label className="text-[10px] font-bold text-slate-500 mb-1 block uppercase tracking-wider">מספר דירה</label>
              ...
              <div className="w-full">
                <label className="text-[10px] font-bold text-slate-500 mb-1 block uppercase tracking-wider">קומה</label>
          ...
          <div className="bg-slate-800 border border-slate-700 rounded-[2rem] p-6 shadow-xl relative overflow-hidden text-white">
            ...
            <div className="flex flex-col gap-3 relative z-10">
              ...
              <button
                ...
                className="w-full bg-white text-slate-800 px-5 py-3.5 rounded-xl text-sm font-bold active:scale-95 transition disabled:opacity-50"
              >
      ...
      {/* פרטי הקהילה לוועד (והזמנת שכנים משודרגת) */}
      {building && !isPending && (
        <div className="px-4 space-y-6">
            ...
            {isAdmin ? (
              <div className="flex gap-2 w-full">
                <input
                  ...
                  className="flex-1 w-0 min-w-0 bg-slate-50 border border-slate-100 rounded-xl px-4 py-3 text-sm outline-none focus:border-[#1D4ED8] transition text-slate-800 font-bold"
                />
                <button
                  onClick={updateBuildingName}
                  disabled={isUpdating || newBuildingName === building.name}
                  className="shrink-0 whitespace-nowrap bg-[#1D4ED8] text-white px-5 py-3 rounded-xl text-xs font-bold active:scale-95 transition disabled:opacity-50 shadow-sm"
                >
            ...
            {isAdmin && (
              <div className="mt-5 pt-5 border-t border-slate-100 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {/* כפתור הווצאפ המקורי שביקשת לחזור אליו */}
          ...
          {isAdmin && pendingNeighbors.length > 0 && (
            <section>
              ...
              <div className="bg-orange-50 border border-orange-100 rounded-[2rem] overflow-hidden shadow-sm">
        ...
        <div className="fixed inset-0 z-[70] bg-black/60 backdrop-blur-sm flex justify-center items-end">
          <div className="bg-white w-full max-w-md rounded-t-[40px] p-6 pb-10 shadow-2xl animate-in slide-in-from-bottom-10">
            <div className="flex justify-between items-center mb-6 px-2">
              ...
              <button onClick={() => setIsAvatarMenuOpen(false)} className="p-2 bg-gray-50 rounded-full text-slate-800 hover:bg-gray-200 transition">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-3 mt-2">
                ...
                <button onClick={resetToInitials} className="w-full flex items-center justify-center gap-2 bg-gray-50 text-slate-800 border border-gray-200 py-4 rounded-[20px] font-bold hover:bg-gray-100 active:scale-95 transition shadow-sm">
