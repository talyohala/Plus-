...
export default function ServicesPage() {
  ...
  // הבועה החדשה - שמירת ה-ID של הכרטיס שלחצו עליו
  ...
  const renderTicketCard = (ticket: any) => {
    ...
    return (
      ...
      >
        ...
        {/* בועה פנימית למקרה לחיצה קצרה */}
        {toastId === ticket.id && (
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-800/90 text-white text-xs font-bold px-4 py-2 rounded-xl shadow-xl z-50 animate-in zoom-in-95 pointer-events-none whitespace-nowrap">
            לחיצה ארוכה לניהול
          </div>
        )}
