...
export default function BottomNav() {
  return (
    <nav className="fixed bottom-0 w-full max-w-md glass-panel flex justify-around items-center p-3 pb-6 z-30 rounded-t-3xl border-b-0 shadow-[0_-5px_20px_rgba(0,0,0,0.05)]">
      ...
      <Link href="/notifications" className="flex flex-col items-center text-brand-gray hover:text-brand-blue transition gap-1 w-14">
