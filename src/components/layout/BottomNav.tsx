export default function BottomNav() {
  return (
    <nav className="fixed bottom-0 w-full max-w-md glass-panel flex justify-around items-center p-3 pb-6 z-30 rounded-t-[2rem] border-b-0">
      <button className="flex flex-col items-center text-brand-blue gap-1 w-14 hover:scale-105 transition">
      ...
      {/* פלוס נקי בשורה אחת */}
      <button className="flex flex-col items-center text-brand-blue hover:scale-110 transition gap-1 w-14">
