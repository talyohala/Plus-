...
export default function Header() {
  ...
  useEffect(() => {
    ...
    fetchHeaderData()
    const channel = supabase.channel('header_fix')
  ...
  return (
    <header className="w-full max-w-md bg-white/80 backdrop-blur-md rounded-b-3xl p-6 pt-10 shadow-sm mb-6 z-20">
      <div className="flex justify-between items-center" dir="rtl">
        ...
        {/* 1. פעמון התראות - מופיע ראשון בקוד = צד ימין ב-RTL */}
        ...
        {/* 3. פרופיל - מופיע אחרון בקוד = צד שמאל ב-RTL */}
        <Link href="/profile" className="w-12 h-12 rounded-full border-2 border-white shadow-sm overflow-hidden bg-gray-100 transition active:scale-95">
          <img 
            src={profile?.avatar_url || 'https://api.dicebear.com/7.x/notionists/svg?seed=guest'} 
